...
const MainRenderBP = blueprint<typeof UE.MainRenderBP_C>('/Game/StarterContent/MainRenderBP.MainRenderBP_C');
...
let bpActor2 =  world.SpawnActor(clsBP, undefined, UE.ESpawnActorCollisionHandlingMethod.Undefined, undefined, undefined) as UE.MainRenderBP_C;
